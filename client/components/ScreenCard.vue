...
<template>
  <div class="relative w-[300px] rounded overflow-hidden shadow-lg bg-white dark:bg-gray-800">
    ...
    <div class="px-6 pt-4 pb-2">
      <select :value="selectedDeckOption?.id ?? null"
...
import { useStartTimeStore } from '@/stores/useStartTimeStore'
...
//this should be calculated by getStartTime(screen.slideDeck.id)
