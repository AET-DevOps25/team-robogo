    ...
    <div class="flex flex-wrap gap-4">
      <draggable v-model="localSlideIds" group="slides" item-key="id" class="flex flex-wrap gap-4"
        ...
        <template #item="{ element }">
          <SlideCard v-if="id2Slide[element]" :item="id2Slide[element]" :selected="selectedContent?.id === element"
    ...
    <div v-if="showDialog"
      ...
      <div class="bg-white dark:bg-gray-800 p-6 rounded-lg w-[600px] max-h-[80vh] overflow-y-auto shadow-lg relative">
        ...
        <div class="flex flex-wrap gap-4 mb-6">
          <SlideCard v-for="s in slides" :key="s.id" :item="s" :selected="s.id === selectedToAdd"
